...
* **Triage**: Worked the 22-message CSMS queue (2026-08-03 → 08-31). The headline is **Section 338 goes live on Canada** — the first-ever use of 19 U.S.C. 1338: Proclamations 11046–11048 impose 50% additional duties on certain Canada goods (alcoholic beverages, dairy, motor vehicles) via headings 9903.03.12–.16, suspended 2026-08-19 → 08-22 by Proclamation 11056 and applying to entries from 2026-08-22 (CSMS # 69606660) — new [source stub](/sources/csms-section-338-canada.md) with the HTS list, distilled into [Tariff Actions](/tariff/tariff-actions-2025-2026.md); all five headings live-verified against 2026HTSRev17. CBP's multi-HTS **reporting-order guidance** now slots Section 338 between 301 and 232 (# 69668138) — captured in [Entry Summary Filing](/ace-filing/entry-summary-filing.md), which also gains the copper smelt/cast **F794 fatal enforcement from 2026-09-14** (# 69711865) and **error dictionary v52** with F883 (PSC cannot modify IEEPA HTS on FTZ type 06, deployed 2026-08-21, # 69635410; v52 XLSX fetched from cbp.gov). The **UK pharma 0%** (9903.04.63) is now in the published schedule per Rev17 — the Rev14-era caution in [Tariff Actions](/tariff/tariff-actions-2025-2026.md) is resolved (HSU 2619, # 69440938). A **Section 201 quartz surface products quota** started 2026-08-05 (91 FR 50645, HSU 2620 # 69578857) — noted as watch-only. [Entry Summary in ACE](/entry/entry-summary-ace.md) gains the **PSC ACH-only payment rule** from 2026-08-05 (91 FR 41053, # 69428352); [Entry Type 13](/entry/entry-type-13-test.md) gains the revised draft Cargo Release CATAIR/condition codes for the 2026-09-22 production deployment (# 69498185). Watch-only entries added for the **Enhanced ACAS enforcement extension to 2027-05-01** (# 69486540) and the **"Flying Trucks" termination 2026-11-24** (# 69657207); the expired APHIS PIS watch entry pruned. Dismissed as routine/out-of-scope: ACE survey + reminder (deny filter added), AESTIR 802 export code, rail EEM final rule (export), drawback FD07 pair, ACH-refund report reminder, deployment-schedule pointer, and three resolved-incident notices.
* **Update**: Auto-refreshed the eCFR Title 19 XML to point-in-time 2026-08-28 (latest amendment 2026-08-26).
* **Update**: Auto-refreshed the HTS JSON export to 2026HTSRev17 (Revision 17 (2026), 35,796 records). Official full-revision PDF refreshed to Revision 17 (2026).
...
* **Update**: Auto-refreshed the HTS JSON export to 2026HTSRev16 (Revision 16 (2026), 35,791 records). Official full-revision PDF refreshed to Revision 16 (2026) (Publication 5780).
